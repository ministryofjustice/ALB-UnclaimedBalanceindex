...
function resetDate() {
	...
	document.getElementById("from_day").value=0;
	document.getElementById("from_month").value=0;
	document.getElementById("from_year").value=0;
	document.getElementById("to_day").value=0;
	document.getElementById("to_month").value=0;
	document.getElementById("to_year").value=0;
