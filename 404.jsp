...
<body class="govuk-template__body ">
  ...
  <a class="govuk-skip-link" href="#main-content">Go to main content</a>
      ...
      <div class="govuk-phase-banner app-phase-banner app-width-container">
        <p class="govuk-phase-banner__content">
          ...
          <span class="govuk-phase-banner__text">
            We've updated and improved this service. Your <a  class="govuk-link" href="https://eu.surveymonkey.com/r/HBC3PDN">feedback</a> will help us to improve it.
          </span>
          </div>  
    </div>
  </div>
      ...
      <div class="govuk-footer__meta">
        <div class="govuk-footer__meta-item govuk-footer__meta-item--grow">
          ...
          <ul class="govuk-footer__inline-list">
            ...
            <li class="govuk-footer__inline-list-item">
              <a class="govuk-footer__link" href="https://www.gov.uk/help/cookies">Cookie policy</a>
            </li>
            <li class="govuk-footer__inline-list-item">
              <a class="govuk-footer__link" href="http://www.courtfunds.gov.uk/contact/contact.htm">Contact us</a>
            </li>
          </ul>
